...
public class GeneralVideoModel {
    ...
    @SerializedName("data")
    @Expose
    private List<PathshalaVideo> data = null;
    ...
    public List<PathshalaVideo> getData() {
        return data;
    }

    public void setData(List<PathshalaVideo> data) {
        this.data = data;
    }

    public class PathshalaVideo {
