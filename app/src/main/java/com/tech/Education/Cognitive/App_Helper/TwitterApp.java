...
public class TwitterApp {
	...
	private void configureToken() {
		System.out.println("this is ConfigureToken Class chetan Testing 8888888888888888"+mAccessToken);
	...
	public void authorize() {
		mProgressDlg.setMessage("Configure ...");
		mProgressDlg.show();
	...
	public void processToken(String callbackUrl)  {
			mProgressDlg.setMessage("Finalize ...");
		mProgressDlg.show();
	...
	private void showLoginDialog(String url) {
		final TwDialogListener listener = new TwDialogListener() {
			...
			public void onError(String value) {
				mListener.onError("\n" +
						"Failed to open permission page");
			}
		};
